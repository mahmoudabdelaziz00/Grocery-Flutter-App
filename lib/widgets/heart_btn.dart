    ...
    return GestureDetector(
      onTap: () async {
        ...
        try{
          ...
          if(user == null)
          {
           await GlobalMethods.errorDialog(subtitle: "No user found, Please login first", context: context);
            return;
          }
          if(widget.isInWishlist == false && widget.isInWishlist != null){
            GlobalMethods.addToWishlist(productId: widget.productId, context: context);
          }else{
