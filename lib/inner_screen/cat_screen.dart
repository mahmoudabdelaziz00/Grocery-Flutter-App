...
import 'package:safwa_u/models/products_model.dart';
import 'package:safwa_u/providers/products_provider.dart';
import 'package:safwa_u/widgets/empty_product_widget.dart';
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: TextField(
                ...
                onChanged: (valuee) {
                  setState(() {
                    listProdcutSearch = productsProviders.searchQuery(valuee);
                  });
                },
